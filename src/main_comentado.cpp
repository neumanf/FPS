...
void drawHay(GLUquadricObj *cylinder) {
    ...
    glTranslatef(0.0f, 0.0f, -HEIGHT);
    //exibe a pilha da matriz atual substituindo a matriz atual pela que esta abaixo dela na pilha
    glPopMatrix();
}
//Desenha moinho
...
void drawHouse(GLUquadricObj *cylinder, GLUquadricObj *disk,
    ...
    // Parede frontal
    //Desenhando o tronco pela metade para a parte central vazia para ser a porta
